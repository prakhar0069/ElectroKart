...
import com.project.electronic.store.repositories.CartItemRepository;
import com.project.electronic.store.repositories.CartRepository;
import com.project.electronic.store.repositories.ProductRepository;
...
public class CartServiceImpl implements CartService {
    ...
    public CartDto addItemToCart(String userId, AddItemToCartRequest request) {
        ...
        //fetch the product
        Product product = productRepository.findById(productId).orElseThrow(() -> new RuntimeException("Product not found in database !!"));
